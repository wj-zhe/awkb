...
// Layer 0 + 2 //
const uint16_t PROGMEM tg2_L0_combo[] = { KC_J, KC_K, KC_L, COMBO_END};
const uint16_t PROGMEM tg2_L2_combo[] = { KC_DOWN, KC_UP, KC_RIGHT, COMBO_END};

// Layer 0 + 3 //
const uint16_t PROGMEM tg3_L0_combo[] = { KC_M, KC_COMM, KC_DOT, COMBO_END};
const uint16_t PROGMEM tg3_L3_combo[] = { KC_P1, KC_P2, KC_P3, COMBO_END};

// Layer 0 + 1 + 2 + 3 //
const uint16_t PROGMEM ent_L0_combo[]   = { KC_K, KC_L, COMBO_END};
const uint16_t PROGMEM ent_L1_combo[]   = { KC_8, KC_9, COMBO_END};
const uint16_t PROGMEM ent_L2_combo[]   = { KC_UP, KC_RIGHT, COMBO_END};
const uint16_t PROGMEM ent_L3_combo[]   = { KC_P5, KC_P6, COMBO_END};
const uint16_t PROGMEM esc_L0_combo[]   = { KC_W, KC_E, COMBO_END};
const uint16_t PROGMEM esc_L1_combo[]   = { KC_AT, KC_HASH, COMBO_END};
const uint16_t PROGMEM esc_L2_combo[]   = { KC_F10, KC_F11, COMBO_END};
const uint16_t PROGMEM esc_L3_combo[]   = { KC_P8, KC_P9, COMBO_END};
const uint16_t PROGMEM esc_L3_2_combo[] = { KC_HOME, KC_UP, COMBO_END};
...
combo_t key_combos[] = {
    ...
    COMBO(ee_clr_combo, EE_CLR),

    COMBO(tg2_L0_combo, TG(2)),
    COMBO(tg2_L2_combo, TG(2)),

    COMBO(tg3_L0_combo, TG(3)),
    COMBO(tg3_L3_combo, TG(3)),

    COMBO(ent_L0_combo, KC_ENT),
    COMBO(ent_L1_combo, KC_ENT),
    COMBO(ent_L2_combo, KC_ENT),
    COMBO(ent_L3_combo, KC_ENT),
    COMBO(esc_L0_combo, KC_ESC),
    COMBO(esc_L1_combo, KC_ESC),
    COMBO(esc_L2_combo, KC_ESC),
    COMBO(esc_L3_combo, KC_ESC),
    COMBO(esc_L3_2_combo, KC_ESC),
