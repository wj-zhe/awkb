...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_36(
            ...
            LSFT_T(KC_Z), KC_X, KC_C, KC_V, LT(3,KC_B),    KC_N, KC_M, KC_COMM, KC_DOT, LSFT_T(KC_SLSH),
                 LT(2,KC_TAB), LALT_T(KC_BSPC), ENC_TG,    KC_NO, LALT_T(KC_SPC), TD(TD_L1)
    ...
    [1] = LAYOUT_36(
            ...
            KC_LSFT, KC_GRV, KC_BSLS, KC_LBRC, KC_RBRC,     KC_EQL, KC_MINS, ___, ___, ___,
                                      KC_LGUI, ___, ___,    KC_NO, ___, TG(1)
            ),
    ...
    [2] = LAYOUT_36(
            ...
            LSFT_T(KC_F1), KC_F2, KC_F3, KC_F4, TO(3),         TD(TD_MD), KC_VOLD, KC_VOLU, KC_MUTE, KC_LSFT,
                                        TG(2), KC_DEL, ___,    KC_NO, LALT_T(KC_APP), KC_DEL
    ...
    [3] = LAYOUT_36(
            ...
            KC_LSFT, KC_MUTE, KC_VOLD, KC_VOLU, TG(3),              KC_P0, KC_P1, KC_P2, KC_P3, LSFT_T(KC_DOT),
                                    KC_NO, KC_NO, KC_NO,            KC_NO, LALT_T(KC_BSPC), KC_ESC

            ),

    [4] = LAYOUT_36(
            KC_LGUI, KC_NO, KC_NO, KC_NO, MS_BTN3,      MS_BTN1, MS_BTN2, KC_NO, KC_NO, KC_RGUI,
            KC_LCTL, KC_NO, KC_NO, MS_BTN1, MS_BTN2,    KC_NO, KC_NO, KC_NO, KC_NO, KC_RCTL,
...
static uint16_t keypress_timer = 0xFFFF;
extern uint16_t mouse_timer;
static uint16_t keypress_timeElapsed = 0, mouse_timeElapsed = 0;
