...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x5_2(
            ...
            KC_LSFT, xxx, xxx, KC_LBRC, KC_RBRC,         KC_EQL, KC_MINS, ___, ___, ___,
                                            ___, ___,    ___, ___
            ),
    ...
    [3] = LAYOUT_split_3x5_2(
            xxx, KC_HOME, KC_UP, KC_PGUP, xxx,             KC_PSLS, KC_P7, KC_P8, KC_P9, KC_PMNS,
            KC_END, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,    KC_PAST, KC_P4, KC_P5, KC_P6, KC_PPLS,
            xxx, xxx, xxx, xxx, TG(3),                     KC_P0, KC_P1, KC_P2, KC_P3, KC_DOT,
