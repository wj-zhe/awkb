...
// Configurations for split keyboard by default
...
// END: Configurations for split keyboard by default 
...
void matrix_init_custom(void) {
    // Config for split keyboard by default
